  ...
  return (
    <>
      ...
      <p>
        ...
        pointer flip that makes the whole new tree &quot;current.&quot;
      ...
      <p>
        ...
        indirection that lets a snapshot say &quot;give me every object as
        of transaction 4,180&quot; and get a consistent historical view of
        the volume without storing anything extra.
      </p>

      <h2>Clones: why &quot;Duplicate&quot; is instant</h2>
      <p>
      ...
      <p>
        ...
        why the &quot;copying&quot; progress bar behaves so differently
      ...
      <p>
        ...
        pool. There is no &quot;resize partition&quot; step, ever - a
      ...
      <p>
        ...
        &quot;this file is inaccessible until first unlock&quot; and
      ...
      <p>
        ...
        sizing), so asking &quot;how big is this folder?&quot; doesn&apos;t
      ...
      <ul>
        <li>
          <strong>&quot;Free space&quot; is a negotiation.</strong> Snapshots
          retain deleted data, and macOS counts space it <em>could</em> free
          (old snapshots, caches - &quot;purgeable&quot; space) as
        ...
        <li>
          ...
          climbs by the changed blocks even though &quot;Get Info&quot;
        ...
        <li>
          ...
          volumes are unreadable without their keys, &quot;Erase All Content
          and Settings&quot; just destroys the keys - no multi-hour
