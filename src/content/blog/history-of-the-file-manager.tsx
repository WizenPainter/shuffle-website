...
export default function HistoryOfTheFileManager() {
  return (
    <>
      ...
      <p>
        For the first decades of computing there was no &quot;file
        manager&quot; as a category, because managing files <em>was</em> what
      ...
      <p>
        Even the mainframe world, where &quot;users&quot; were institutions,
      ...
      <p>
        ...
        genre, the &quot;orthodox file manager,&quot; and it is still being
      ...
      <p>
        ...
        its folders &quot;drawers.&quot; Digital Research&apos;s GEM (also
