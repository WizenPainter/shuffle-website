...
export default function WhatMakesAFileManagerFast() {
  return (
    <>
      <p>
        &ldquo;Fast&rdquo; is not a marketing adjective — it is a number with
      ...
      <p>
        ...
        &ldquo;windowed&rdquo;) list keeps the full item array in memory as
      ...
      <p>
        ...
        <code>n × height</code> — which is one quiet reason dense,
      ...
      <p>
        ...
        &ldquo;calculate all sizes,&rdquo; <code>.DS_Store</code>{" "}
